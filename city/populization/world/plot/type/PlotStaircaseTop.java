...
public class PlotStaircaseTop extends Plot{
    public PlotStaircaseTop(String name, int crushResistance, int friction, int weight, int tension, PlotRender model){
    ...
    public boolean isBuildable(Player localPlayer, PlotPos pos, World world) {
        return world.getPlot(pos.shift(Direction.DOWN))==Plot.Staircase;
    }
}
