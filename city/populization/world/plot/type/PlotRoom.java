...
public class PlotRoom extends PlotEntitied{
    private final int bedrooms;
    private final int cost;
    public PlotRoom(String name, int crushResistance, int friction, int weight, int tension, PlotRender model, int bedrooms, int cost){
    ...
    public PlotEntity createNewEntity() {
        throw new UnsupportedOperationException("Not supported yet."); //TODO create a new Room entity, like the house
    }
    @Override
