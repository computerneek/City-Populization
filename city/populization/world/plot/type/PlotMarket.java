...
import city.populization.world.plot.entity.PlotEntityMarket;
import city.populization.world.plot.render.PlotRender;
import java.util.Arrays;
import java.util.Collections;
public class PlotMarket extends PlotEntitied{
    public PlotMarket(String name, int crushResistance, int friction, int weight, int tension, PlotRender model){
