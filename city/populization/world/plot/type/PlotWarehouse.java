...
import city.populization.world.plot.entity.PlotEntityWarehouse;
import city.populization.world.plot.render.PlotRender;
import java.util.Arrays;
import java.util.Collections;
public class PlotWarehouse extends PlotEntitied{
    public PlotWarehouse(String name, int crushResistance, int friction, int weight, int tension, PlotRender model){
    ...
    public PlotEntity createNewEntity() {
        return new PlotEntityWarehouse();
    }
    @Override
