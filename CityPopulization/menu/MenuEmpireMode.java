...
public class MenuEmpireMode extends Menu{
    ...
    public void renderBackground(){
        play.enabled = delete.enabled = missionList.getSelectedIndex()>=0;
    }
    @Override
    ...
    private void play(){
        WorldInfo info = ((ListComponentWorld)missionList.components.get(missionList.getSelectedIndex())).info;
