...
public class ListComponentAircraftSchedule extends ListComponent {
    ...
    public void render(double x, double y, double minX, double minY, double maxX, double maxY){
        ...
        drawCenteredTextWithBounds(x+0.02, y+0.02, x+getWidthD()-0.02, y+0.06, minX, minY, maxX, maxY, element.getAircraftName()+"; $"+element.getAircraftCost()+"; "+element.getFuelCost()+" fuel");
        drawCenteredTextWithBounds(x+0.02, y+0.06, x+getWidthD()-0.02, y+0.1, minX, minY, maxX, maxY, "Passengers:  Up to "+element.getMaxPassengerCount()+" (Next:  "+element.getPassengerCount()+")");
        drawCenteredTextWithBounds(x+0.02, y+0.1, x+getWidthD()-0.02, y+0.14, minX, minY, maxX, maxY, "Cargo:  "+element.getCargo().toString());
        drawCenteredTextWithBounds(x+0.02, y+0.14, x+getWidthD()-0.02, y+0.18, minX, minY, maxX, maxY, "Next arrival in "+element.getTimeUntilNextArrival());
