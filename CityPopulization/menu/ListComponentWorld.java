...
public class ListComponentWorld extends ListComponent{
    ...
    public void render(double x, double y, double minX, double minY, double maxX, double maxY){
        ...
        drawCenteredTextWithBounds(x+0.02, y+0.02, x+getWidth()-0.02, y+0.1, minX, minY, maxX, maxY, info.name);
        drawCenteredTextWithBounds(x+0.02, y+0.1, x+getWidth()-0.02, y+0.18, minX, minY, maxX, maxY, info.template);
        drawCenteredTextWithBounds(x+0.02, y+0.18, x+getWidth()-0.02, y+0.26, minX, minY, maxX, maxY, info.size);
        drawCenteredTextWithBounds(x+0.02, y+0.26, x+getWidth()-0.02, y+0.34, minX, minY, maxX, maxY, info.created);
