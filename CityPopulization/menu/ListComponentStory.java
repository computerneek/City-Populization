...
public class ListComponentStory extends ListComponent {
    ...
    public void render(double x, double y, double minX, double minY, double maxX, double maxY){
        ...
        drawCenteredTextWithBounds(x+0.02, y+0.02, x+getWidthD()-0.02, y+0.1, minX, minY, maxX, maxY, mission.name());
        drawCenteredTextWithBounds(x+0.02, y+0.1, x+getWidthD()-0.02, y+0.18, minX, minY, maxX, maxY, mission.difficulty());
        drawCenteredTextWithBounds(x+0.02, y+0.18, x+getWidthD()-0.02, y+0.26, minX, minY, maxX, maxY, mission.lastScore());
        drawCenteredTextWithBounds(x+0.02, y+0.26, x+getWidthD()-0.02, y+0.34, minX, minY, maxX, maxY, mission.highScore());
