...
public class MenuStory extends Menu{
    ...
    public void onGUIOpened(){
        ...
        missionList.components.get(missionList.selectedIndex).isSelected = true;
    ...
    private void play(){
        ((ListComponentStory)missionList.components.get(missionList.selectedIndex)).mission.play();
    }
    private void back(){
        gui.open(parent);
    }
