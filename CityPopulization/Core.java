...
import CityPopulization.menu.MenuAirportSchedule_NewAircraft;
...
public class Core{
    ...
    public static boolean render(int millisSinceLastTick){
        ...
        if(gui.menu!=null&&(gui.menu instanceof MenuIngame||gui.menu instanceof MenuAirportSchedule||
                gui.menu instanceof MenuAirportSchedule_NewAircraft||gui.menu instanceof CityPopulization.world.story.Display)) Core.world.render();
