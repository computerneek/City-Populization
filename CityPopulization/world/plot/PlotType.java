...
public enum PlotType{
    Grass("Grass", "grass", new ResourceList(Resource.Dirt, 500), new CubeRenderer(), 1, true, true, Side.values()),
    Dirt("Dirt", "dirt", new ResourceList(Resource.Dirt, 500), new CubeRenderer(), 1, true, true, Side.values()),
    ...
    CoalDeposit("Coal", "coal", new ResourceList(Resource.Coal, 500), new CubeRenderer(), 1, true, true, Side.values()),
    Air("Air", "air", new ResourceList(), new NonRenderer(), 1, false, false, Side.values()),
    OilDeposit("Oil", "oil", new ResourceList(Resource.Oil, 500), new CubeRenderer(), 1, true, true, new Side[0]),
    Woods("Forest", "woods", new ResourceList(Resource.Wood, 500), new ForestRenderer(), 1, false, true, Side.values()),
    Stone("Stone", "stone", new ResourceList(Resource.Stone, 500), new CubeRenderer(), 1, true, true, Side.values()),
    IronDeposit("Iron", "iron", new ResourceList(Resource.Iron, 500), new CubeRenderer(), 1, true, true, Side.values()),
    Sand("Sand", "sand", new ResourceList(Resource.Sand, 500), new CubeRenderer(), 1, true, true, Side.values()),
    ClayDeposit("Clay", "clay", new ResourceList(Resource.Clay, 500), new CubeRenderer(), 1, true, true, Side.values()),
    GoldDeposit("Gold", "gold", new ResourceList(Resource.Gold, 500), new CubeRenderer(), 1, true, true, Side.values()),
